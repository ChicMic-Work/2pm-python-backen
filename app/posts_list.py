...
from utilities.constants import (
    DAILY_QUES_NOT_FOUND, DRAFT_NOT_FOUND, EMPTY_SEARCH_STRING, INVALID_POST_TYPE, INVALID_SEARCH_QUERY, REDIS_DB, AuthTokenHeaderKey, HOPSortType, PostListType, PostType, RandomSample, ResponseKeys, ResponseMsg
)
...
async def daily_read_page_images(
    ...
    try:
        ...
        if not images_urls:
            ...
            images_urls = [f"{image}" for image in _list if os.path.isfile(os.path.join(curr_dir, image))]
